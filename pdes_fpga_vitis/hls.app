<project xmlns="com.autoesl.autopilot.project" name="pdes_fpga_vitis" top="event_history_kernel" enableIndexer="false">
    <includePaths/>
    <libraryPaths/>
    <libraryFlag/>
    <Simulation argv="">
    ...
    <files xmlns="">
        ...
        <file name="cpp/EventHistory.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
        <file name="cpp/EventHistory.hpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
