...
module state_buffer_kernel_state_buffer_kernel_Pipeline_VITIS_LOOP_154_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] current_V_2_reg_261;
reg   [5:0] list_lp_heads_V_addr_reg_266;
...
reg   [15:0] current_V_1_fu_56;
wire   [15:0] current_V_3_fu_216_p3;
reg   [15:0] ap_sig_allocacmp_current_V_2;
reg   [15:0] removed_V_fu_60;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        list_lp_heads_V_addr_reg_266 <= zext_ln587_5_cast_fu_127_p1;
    end
end
...
assign current_V_3_fu_216_p3 = ((addr_cmp_reg_300[0:0] == 1'b1) ? reuse_reg_load_reg_295 : list_nodes_next_V_q0);

assign icmp_ln1069_fu_155_p2 = ((ap_sig_allocacmp_current_V_2 == 16'd65535) ? 1'b1 : 1'b0);

assign icmp_ln1081_fu_176_p2 = (($signed(list_nodes_state_lvt_V_q0) > $signed(commit_time_V)) ? 1'b1 : 1'b0);

assign list_lp_heads_V_address0 = list_lp_heads_V_addr_reg_266;

assign list_lp_heads_V_d0 = ((addr_cmp_reg_300[0:0] == 1'b1) ? reuse_reg_load_reg_295 : list_nodes_next_V_q0);

assign list_nodes_next_V_address0 = zext_ln587_reg_275;

assign list_nodes_next_V_d0 = list_free_head_V_i;

assign list_nodes_state_lvt_V_address0 = zext_ln587_fu_161_p1;

assign removed_V_2_fu_170_p2 = (removed_V_fu_60 + 16'd1);

assign removed_V_out = removed_V_fu_60;

assign zext_ln587_5_cast_fu_127_p1 = zext_ln587_5;

assign zext_ln587_fu_161_p1 = ap_sig_allocacmp_current_V_2;

always @ (posedge ap_clk) begin
    zext_ln587_reg_275[63:16] <= 48'b000000000000000000000000000000000000000000000000;
end

endmodule //state_buffer_kernel_state_buffer_kernel_Pipeline_VITIS_LOOP_154_1
