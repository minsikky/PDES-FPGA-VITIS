...
module event_queue_kernel_event_queue_kernel_Pipeline_VITIS_LOOP_305_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_ready,
        time_r,
        g_event_queue_lp_heads_V_0_i,
        g_event_queue_lp_heads_V_0_o,
        g_event_queue_lp_heads_V_0_o_ap_vld,
        ...
        g_event_queue_lp_tails_V_0,
        g_event_queue_lp_tails_V_0_ap_vld
);
...
output   ap_ready;
input  [31:0] time_r;
input  [15:0] g_event_queue_lp_heads_V_0_i;
output  [15:0] g_event_queue_lp_heads_V_0_o;
output   g_event_queue_lp_heads_V_0_o_ap_vld;
...
output  [15:0] g_event_queue_lp_tails_V_0;
output   g_event_queue_lp_tails_V_0_ap_vld;

reg ap_idle;
reg[15:0] g_event_queue_lp_heads_V_0_o;
reg g_event_queue_lp_heads_V_0_o_ap_vld;
...
reg g_event_queue_lp_tails_V_0_ap_vld;
...
wire   [63:0] zext_ln587_1_fu_98_p1;
reg   [63:0] zext_ln587_1_reg_206;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1069_fu_92_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        zext_ln587_1_reg_206[15 : 0] <= zext_ln587_1_fu_98_p1[15 : 0];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        g_event_queue_lp_heads_V_0_o_ap_vld = 1'b1;
    end else begin
        g_event_queue_lp_heads_V_0_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1065_fu_166_p2 == 1'd1))) begin
        g_event_queue_lp_tails_V_0_ap_vld = 1'b1;
    end else begin
        g_event_queue_lp_tails_V_0_ap_vld = 1'b0;
    end
end
...
assign addr_cmp_fu_114_p2 = ((reuse_addr_reg_fu_38 == zext_ln587_1_reg_206) ? 1'b1 : 1'b0);
...
assign g_event_queue_buffer_event_recv_time_V_address0 = zext_ln587_1_fu_98_p1;

assign g_event_queue_buffer_next_V_address0 = zext_ln587_1_reg_206;

assign g_event_queue_buffer_next_V_d0 = g_event_queue_free_head_V_i;

assign g_event_queue_lp_tails_V_0 = 16'd65535;
...
assign zext_ln587_1_fu_98_p1 = ap_sig_allocacmp_commit_entry_V;

always @ (posedge ap_clk) begin
    zext_ln587_1_reg_206[63:16] <= 48'b000000000000000000000000000000000000000000000000;
end

endmodule //event_queue_kernel_event_queue_kernel_Pipeline_VITIS_LOOP_305_2
