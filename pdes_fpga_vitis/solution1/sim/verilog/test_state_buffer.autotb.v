...
`define AUTOTB_DUT      test_state_buffer
`define AUTOTB_DUT_INST AESL_inst_test_state_buffer
`define AUTOTB_TOP      apatb_test_state_buffer_top
`define AUTOTB_LAT_RESULT_FILE "test_state_buffer.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "test_state_buffer.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_test_state_buffer_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 2.50

`define AESL_DEPTH_in_stream 1
`define AESL_DEPTH_out_stream 1
`define AUTOTB_TVIN_in_stream  "../tv/cdatafile/c.test_state_buffer.autotvin_in_stream.dat"
`define AUTOTB_TVIN_in_stream_out_wrapc  "../tv/rtldatafile/rtl.test_state_buffer.autotvin_in_stream.dat"
`define AUTOTB_TVOUT_out_stream  "../tv/cdatafile/c.test_state_buffer.autotvout_out_stream.dat"
`define AUTOTB_TVOUT_out_stream_out_wrapc  "../tv/rtldatafile/rtl.test_state_buffer.autotvout_out_stream.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_in_stream = 7;
parameter LENGTH_out_stream = 67;
...
reg [31:0] ap_c_n_tvin_trans_num_out_stream;
