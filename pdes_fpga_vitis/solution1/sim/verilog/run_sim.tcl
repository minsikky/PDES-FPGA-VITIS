...
if {[file isfile state_buffer_kernel.autotvin.dat]} {
	file delete -force state_buffer_kernel.autotvin.dat
}

if {[file isfile state_buffer_kernel.autotvout.dat]} {
	file delete -force state_buffer_kernel.autotvout.dat
}
