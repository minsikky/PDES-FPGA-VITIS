...
if {[file isfile event_history_kernel.autotvin.dat]} {
	file delete -force event_history_kernel.autotvin.dat
}

if {[file isfile event_history_kernel.autotvout.dat]} {
	file delete -force event_history_kernel.autotvout.dat
}
