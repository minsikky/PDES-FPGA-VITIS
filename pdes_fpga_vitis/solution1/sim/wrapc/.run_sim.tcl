...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "event_queue_kernel.autotvin.dat"
	set constFileTvOut       "event_queue_kernel.autotvout.dat"
	set constFileHdlTvIn     "event_queue_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "event_queue_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
