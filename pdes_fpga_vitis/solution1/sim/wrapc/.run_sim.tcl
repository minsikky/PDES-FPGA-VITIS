...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "state_buffer_kernel.autotvin.dat"
	set constFileTvOut       "state_buffer_kernel.autotvout.dat"
	set constFileHdlTvIn     "state_buffer_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "state_buffer_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
