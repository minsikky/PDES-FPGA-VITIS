...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "test_state_buffer.autotvin.dat"
	set constFileTvOut       "test_state_buffer.autotvout.dat"
	set constFileHdlTvIn     "test_state_buffer.autohdltvin.dat"
	set constFileHdlTvOut    "test_state_buffer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
