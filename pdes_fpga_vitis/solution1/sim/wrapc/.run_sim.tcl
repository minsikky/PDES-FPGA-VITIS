...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /afs/eecs.umich.edu/soft/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /afs/eecs.umich.edu/soft/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /afs/eecs.umich.edu/soft/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /afs/eecs.umich.edu/soft/xilinx/2022.1/Vitis_HLS/2022.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "event_history_kernel.autotvin.dat"
	set constFileTvOut       "event_history_kernel.autotvout.dat"
	set constFileHdlTvIn     "event_history_kernel.autohdltvin.dat"
	set constFileHdlTvOut    "event_history_kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
