...
module lpcore_top_lpcore_commit_control (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    lpcore_commit_time_stream_blk_n;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (cancellation_unit_commit_time_stream17_full_n == 1'b0) | (state_buffer_commit_time_stream16_full_n == 1'b0) | (event_queue_commit_time_stream15_full_n == 1'b0) | (lpcore_commit_time_stream_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((ap_start == 1'b0) | (cancellation_unit_commit_time_stream17_full_n == 1'b0) | (state_buffer_commit_time_stream16_full_n == 1'b0) | (event_queue_commit_time_stream15_full_n == 1'b0) | (lpcore_commit_time_stream_empty_n == 1'b0) | (ap_done_reg == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (cancellation_unit_commit_time_stream17_full_n == 1'b0) | (state_buffer_commit_time_stream16_full_n == 1'b0) | (event_queue_commit_time_stream15_full_n == 1'b0) | (lpcore_commit_time_stream_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        lpcore_commit_time_stream_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (cancellation_unit_commit_time_stream17_full_n == 1'b0) | (state_buffer_commit_time_stream16_full_n == 1'b0) | (event_queue_commit_time_stream15_full_n == 1'b0) | (lpcore_commit_time_stream_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        lpcore_commit_time_stream_read = 1'b1;
    end else begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (cancellation_unit_commit_time_stream17_full_n == 1'b0) | (state_buffer_commit_time_stream16_full_n == 1'b0) | (event_queue_commit_time_stream15_full_n == 1'b0) | (lpcore_commit_time_stream_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign cancellation_unit_commit_time_stream17_din = lpcore_commit_time_stream_dout;

assign event_queue_commit_time_stream15_din = lpcore_commit_time_stream_dout;

assign state_buffer_commit_time_stream16_din = lpcore_commit_time_stream_dout;

endmodule //lpcore_top_lpcore_commit_control
