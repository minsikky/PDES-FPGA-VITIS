...
module simulation_top_commit_Pipeline_VITIS_LOOP_237_23 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [15:0] this_8_2_reload;
input  [15:0] this_6_2_reload;
...
output  [15:0] this_8_3_out;
output   this_8_3_out_ap_vld;
output  [15:0] this_6_3_out;
output   this_6_3_out_ap_vld;
...
reg this_0_2_we0;
reg this_0_0_1_ce0;
reg[15:0] this_8_3_out;
reg this_8_3_out_ap_vld;
reg[15:0] this_6_3_out;
reg this_6_3_out_ap_vld;
...
wire   [15:0] commit_entry_V_1_fu_221_p3;
reg   [15:0] commit_entry_V_1_reg_388;
...
reg   [15:0] commit_entry_V_load_2_reg_423;
...
reg   [15:0] this_8_3_fu_70;
wire   [15:0] add_ln887_fu_269_p2;
wire   [15:0] this_8_3_load_1_load_fu_327_p1;
wire    ap_block_pp0_stage2_01001;
wire   [0:0] icmp_ln1065_fu_304_p2;
wire   [0:0] icmp_ln1065_24_fu_309_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1065_24_fu_309_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        this_2_we0 = 1'b1;
    end else begin
        this_2_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((((icmp_ln1069_reg_394 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((icmp_ln1069_reg_394 == 1'd0) & (icmp_ln1085_fu_240_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        this_6_3_out_ap_vld = 1'b1;
    end else begin
        this_6_3_out_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if ((((icmp_ln1069_reg_394 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((icmp_ln1069_reg_394 == 1'd0) & (icmp_ln1085_fu_240_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2)))) begin
        this_8_3_out_ap_vld = 1'b1;
    end else begin
        this_8_3_out_ap_vld = 1'b0;
    end
end
...
assign add_ln887_fu_269_p2 = ($signed(this_8_3_fu_70) + $signed(16'd65535));

assign addr_cmp9_fu_215_p2 = ((reuse_addr_reg6_fu_50 == 64'd3) ? 1'b1 : 1'b0);
...
assign commit_entry_V_1_fu_221_p3 = ((addr_cmp9_fu_215_p2[0:0] == 1'b1) ? reuse_reg5_fu_54 : this_1_q1);

assign commit_entry_V_load_load_fu_323_p1 = commit_entry_V_fu_66;

assign icmp_ln1065_24_fu_309_p2 = ((reuse_select_fu_287_p3 == 16'd65535) ? 1'b1 : 1'b0);

assign icmp_ln1065_fu_304_p2 = ((commit_entry_V_1_reg_388 == this_4_q0) ? 1'b1 : 1'b0);

assign icmp_ln1069_fu_229_p2 = ((commit_entry_V_1_fu_221_p3 == 16'd65535) ? 1'b1 : 1'b0);
...
assign this_1_address0 = 64'd3;

assign this_1_address1 = 64'd3;

assign this_1_d0 = reuse_select_fu_287_p3;

assign this_2_address0 = 64'd3;

assign this_2_d0 = 16'd65535;

assign this_4_addr_reg_415 = 64'd3;

assign this_4_d0 = 16'd65535;

assign this_8_3_load_1_load_fu_327_p1 = this_8_3_fu_70;

assign zext_ln587_fu_235_p1 = commit_entry_V_1_fu_221_p3;

always @ (posedge ap_clk) begin
    zext_ln587_reg_398[63:16] <= 48'b000000000000000000000000000000000000000000000000;
    reuse_addr_reg6_fu_50[1:0] <= 2'b11;
end

endmodule //simulation_top_commit_Pipeline_VITIS_LOOP_237_23
