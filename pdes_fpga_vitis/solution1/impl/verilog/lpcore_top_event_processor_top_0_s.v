...
module lpcore_top_event_processor_top_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] tmp_reg_142;
reg   [0:0] event_is_anti_message_V_reg_146;
reg   [15:0] state_lp_id_V_reg_151;
reg   [31:0] state_rng_state_V_reg_156;
reg   [31:0] event_recv_time_V_reg_161;
reg   [1:0] trunc_ln145_s_reg_166;
wire    grp_process_event_fu_70_ap_start;
wire    grp_process_event_fu_70_ap_done;
wire    grp_process_event_fu_70_ap_idle;
wire    grp_process_event_fu_70_ap_ready;
wire   [79:0] grp_process_event_fu_70_state_buffer_input_stream_din;
wire    grp_process_event_fu_70_state_buffer_input_stream_write;
wire   [128:0] grp_process_event_fu_70_output_event_stream_din;
wire    grp_process_event_fu_70_output_event_stream_write;
wire   [128:0] grp_process_event_fu_70_cancellation_unit_input_stream_din;
wire    grp_process_event_fu_70_cancellation_unit_input_stream_write;
reg    grp_process_event_fu_70_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 2'd1;
#0 grp_process_event_fu_70_ap_start_reg = 1'b0;
end

lpcore_top_process_event grp_process_event_fu_70(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_process_event_fu_70_ap_start_reg <= 1'b0;
    end else begin
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_56_p3 == 1'd1) & (event_processor_input_stream_empty_n == 1'b0))) & (tmp_nbreadreq_fu_56_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_process_event_fu_70_ap_start_reg <= 1'b1;
        end else if ((grp_process_event_fu_70_ap_ready == 1'b1)) begin
            grp_process_event_fu_70_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((tmp_nbreadreq_fu_56_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        event_is_anti_message_V_reg_146 <= event_processor_input_stream_dout[32'd128];
        event_recv_time_V_reg_161 <= {{event_processor_input_stream_dout[63:32]}};
        state_lp_id_V_reg_151 <= {{event_processor_input_stream_dout[144:129]}};
        state_rng_state_V_reg_156 <= {{event_processor_input_stream_dout[208:177]}};
        trunc_ln145_s_reg_166 <= {{event_processor_input_stream_dout[113:112]}};
    end
end
...
always @ (*) begin
    if (((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_56_p3 == 1'd1) & (event_processor_input_stream_empty_n == 1'b0)))) begin
...
always @ (*) begin
    if (((tmp_reg_142 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        cancellation_unit_input_stream_write = grp_process_event_fu_70_cancellation_unit_input_stream_write;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (tmp_nbreadreq_fu_56_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_56_p3 == 1'd1) & (event_processor_input_stream_empty_n == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_56_p3 == 1'd1) & (event_processor_input_stream_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state1_ignore_call6 = ((ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((tmp_nbreadreq_fu_56_p3 == 1'd1) & (event_processor_input_stream_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_on_subcall_done = ((grp_process_event_fu_70_ap_done == 1'b0) & (tmp_reg_142 == 1'd1));
end

assign cancellation_unit_input_stream_din = grp_process_event_fu_70_cancellation_unit_input_stream_din;

assign grp_process_event_fu_70_ap_start = grp_process_event_fu_70_ap_start_reg;

assign output_event_stream_din = grp_process_event_fu_70_output_event_stream_din;

assign state_buffer_input_stream_din = grp_process_event_fu_70_state_buffer_input_stream_din;

assign tmp_nbreadreq_fu_56_p3 = event_processor_input_stream_empty_n;

endmodule //lpcore_top_event_processor_top_0_s
