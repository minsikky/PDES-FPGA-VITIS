...
module lpcore_top_cancellation_unit_top_0_Pipeline_VITIS_LOOP_58_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
reg    cancellation_unit_output_stream_blk_n;
...
wire   [15:0] add_ln887_3_fu_310_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        cancellation_unit_output_stream_blk_n = 1'b1;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        cancellation_unit_output_stream_write = 1'b1;
    end else begin
...
assign add_ln887_3_fu_310_p2 = ($signed(cancellation_unit_total_size_V_i) + $signed(16'd65535));
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((cancellation_unit_output_stream_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((cancellation_unit_output_stream_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((cancellation_unit_output_stream_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1 = (cancellation_unit_output_stream_full_n == 1'b0);
end
...
endmodule //lpcore_top_cancellation_unit_top_0_Pipeline_VITIS_LOOP_58_1
