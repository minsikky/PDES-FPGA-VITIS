...
set Library     "hls"
set IPName      "simulation_top"
set Version     "1.0"
set DisplayName "Simulation_top"
set Revision    "2113691459"
...
set xo_kernel_name "simulation_top"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/n/higgins/z/minsikky/PDES-FPGA-VITIS/pdes_fpga_vitis/solution1"
set debug_dir "/n/higgins/z/minsikky/PDES-FPGA-VITIS/pdes_fpga_vitis/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {simulation_top_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "simulation_top"
set TopNoPrefix "simulation_top"
...
set Interfaces {
    ...
    lpcore_event_queue_full_stream_0 {
        type "ap_fifo"
        fifo_width "1"
        fifo_type "write"
        ctype {
    ...
    lpcore_event_queue_full_stream_1 {
        type "ap_fifo"
        fifo_width "1"
        fifo_type "write"
        ctype {
    ...
    lpcore_cancellation_unit_output_stream_0 {
        type "ap_fifo"
        fifo_width "129"
        fifo_type "write"
        ctype {
    ...
    lpcore_cancellation_unit_output_stream_1 {
        type "ap_fifo"
        fifo_width "129"
        fifo_type "write"
        ctype {
...
source -notrace "/afs/eecs.umich.edu/soft/xilinx/2022.1/Vitis_HLS/2022.1/common/scripts/ipxhls.tcl"
