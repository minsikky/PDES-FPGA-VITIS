...
entity event_history_kernel_event_history_kernel_Pipeline_VITIS_LOOP_94_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of event_history_kernel_event_history_kernel_Pipeline_VITIS_LOOP_94_2 is 
...
attribute shreg_extract : string;
    ...
    signal current_V_5_reg_240 : STD_LOGIC_VECTOR (15 downto 0);
    signal history_lp_heads_V_addr_reg_246 : STD_LOGIC_VECTOR (5 downto 0);
    signal history_lp_sizes_V_addr_reg_251 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_ln1069_reg_256 : STD_LOGIC_VECTOR (0 downto 0);
    signal history_buffer_next_V_addr_reg_260 : STD_LOGIC_VECTOR (5 downto 0);
    signal current_V_6_reg_270 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln587_2_fu_155_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln587_3_fu_175_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln1065_fu_169_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal removed_V_fu_184_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal current_V_1_fu_44 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    component event_history_kernel_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_sequential_init_U : component event_history_kernel_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    current_V_1_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                current_V_5_reg_240 <= ap_sig_allocacmp_current_V_5;
                    history_lp_heads_V_addr_reg_246(3 downto 0) <= zext_ln1073_cast_fu_130_p1(6 - 1 downto 0)(3 downto 0);
                    history_lp_sizes_V_addr_reg_251(3 downto 0) <= zext_ln1073_cast_fu_130_p1(6 - 1 downto 0)(3 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1069_fu_149_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                history_buffer_next_V_addr_reg_260 <= zext_ln587_2_fu_155_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    history_lp_heads_V_addr_reg_246(5 downto 4) <= "00";
    history_lp_sizes_V_addr_reg_251(5 downto 4) <= "00";
    ...
    ap_sig_allocacmp_current_V_5_assign_proc : process(ap_CS_fsm_state1, current_V, current_V_1_fu_44, ap_loop_init)
    begin
    ...
    history_buffer_event_recv_time_V_address0 <= zext_ln587_2_fu_155_p1(6 - 1 downto 0);

    history_buffer_event_recv_time_V_ce0_assign_proc : process(ap_CS_fsm_state1, ap_start_int)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then 
    ...
    history_buffer_next_V_address0_assign_proc : process(ap_CS_fsm_state1, icmp_ln1069_fu_149_p2, ap_CS_fsm_state3, icmp_ln1069_reg_256, history_buffer_next_V_addr_reg_260, ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, icmp_ln1085_reg_275, zext_ln587_2_fu_155_p1, zext_ln587_3_fu_175_p1, icmp_ln1065_fu_169_p2)
    begin
        if (((icmp_ln1069_reg_256 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1085_reg_275 = ap_const_lv1_0))) then 
            ...
            history_buffer_next_V_address0 <= zext_ln587_3_fu_175_p1(6 - 1 downto 0);
        elsif (((icmp_ln1069_fu_149_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            history_buffer_next_V_address0 <= zext_ln587_2_fu_155_p1(6 - 1 downto 0);
        else 
    ...
    history_buffer_next_V_ce0_assign_proc : process(ap_CS_fsm_state1, icmp_ln1069_fu_149_p2, ap_CS_fsm_state3, icmp_ln1069_reg_256, ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, icmp_ln1085_reg_275, icmp_ln1065_fu_169_p2, ap_start_int)
    begin
    ...
    history_buffer_next_V_d0_assign_proc : process(ap_CS_fsm_state3, history_buffer_next_V_q0, history_free_head_V_i, icmp_ln1069_reg_256, ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, icmp_ln1085_reg_275, icmp_ln1065_fu_169_p2)
    begin
        if (((icmp_ln1069_reg_256 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1085_reg_275 = ap_const_lv1_0))) then 
    ...
    history_buffer_next_V_we0_assign_proc : process(ap_CS_fsm_state3, icmp_ln1069_reg_256, ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, icmp_ln1085_reg_275, icmp_ln1065_fu_169_p2)
    begin
    ...
    history_free_head_V_o_assign_proc : process(ap_CS_fsm_state3, history_free_head_V_i, current_V_5_reg_240, icmp_ln1069_reg_256, icmp_ln1085_reg_275)
    begin
        if (((icmp_ln1069_reg_256 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1085_reg_275 = ap_const_lv1_0))) then 
    ...
    history_free_head_V_o_ap_vld_assign_proc : process(ap_CS_fsm_state3, icmp_ln1069_reg_256, icmp_ln1085_reg_275)
    begin
        if (((icmp_ln1069_reg_256 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1085_reg_275 = ap_const_lv1_0))) then 
    ...
    history_lp_heads_V_address0 <= history_lp_heads_V_addr_reg_246;

    history_lp_heads_V_ce0_assign_proc : process(ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
    ...
    history_lp_heads_V_we0_assign_proc : process(ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, icmp_ln1065_fu_169_p2)
    begin
    ...
    history_lp_sizes_V_address0 <= history_lp_sizes_V_addr_reg_251;

    history_lp_sizes_V_ce0_assign_proc : process(ap_CS_fsm_state3, icmp_ln1069_reg_256, ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, icmp_ln1085_reg_275)
    begin
    ...
    history_lp_sizes_V_we0_assign_proc : process(ap_CS_fsm_state3, icmp_ln1069_reg_256, icmp_ln1085_reg_275)
    begin
        if (((icmp_ln1069_reg_256 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1085_reg_275 = ap_const_lv1_0))) then 
    ...
    icmp_ln1069_fu_149_p2 <= "1" when (ap_sig_allocacmp_current_V_5 = ap_const_lv16_FFFF) else "0";
    icmp_ln1085_fu_161_p2 <= "1" when (signed(history_buffer_event_recv_time_V_q0) > signed(commit_time_V)) else "0";

    removed_V_1_out_o_assign_proc : process(removed_V_1_out_i, ap_CS_fsm_state2, icmp_ln1085_fu_161_p2, removed_V_fu_184_p2)
    begin
    ...
    removed_V_1_out_o_ap_vld_assign_proc : process(ap_CS_fsm_state2, icmp_ln1085_fu_161_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln1085_fu_161_p2 = ap_const_lv1_0))) then 
            removed_V_1_out_o_ap_vld <= ap_const_logic_1;
        else 
            removed_V_1_out_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    removed_V_fu_184_p2 <= std_logic_vector(unsigned(removed_V_1_out_i) + unsigned(ap_const_lv16_1));
    zext_ln1073_cast_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln1073),64));
    zext_ln587_2_fu_155_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_current_V_5),64));
    zext_ln587_3_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_V_fu_48),64));
end behav;
