...
entity simulation_top_cancellation_unit_top_1_Pipeline_VITIS_LOOP_58_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of simulation_top_cancellation_unit_top_1_Pipeline_VITIS_LOOP_58_1 is 
...
attribute shreg_extract : string;
    ...
    signal current_V_29_reg_420 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal add_ln887_5_fu_310_p2 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal current_V_21_fu_84 : STD_LOGIC_VECTOR (15 downto 0);
    signal current_V_30_fu_338_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_sig_allocacmp_current_V_29 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    current_V_21_fu_84_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    add_ln887_5_fu_310_p2 <= std_logic_vector(unsigned(cancellation_unit_total_size_V_i) + unsigned(ap_const_lv16_FFFF));
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, lpcore_cancellation_unit_output_stream_1_full_n)
    begin
                ap_block_pp0_stage0_01001 <= ((lpcore_cancellation_unit_output_stream_1_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, lpcore_cancellation_unit_output_stream_1_full_n)
    begin
                ap_block_pp0_stage0_11001 <= ((lpcore_cancellation_unit_output_stream_1_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, lpcore_cancellation_unit_output_stream_1_full_n)
    begin
                ap_block_pp0_stage0_subdone <= ((lpcore_cancellation_unit_output_stream_1_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_block_state3_pp0_stage0_iter1_assign_proc : process(lpcore_cancellation_unit_output_stream_1_full_n)
    begin
                ap_block_state3_pp0_stage0_iter1 <= (lpcore_cancellation_unit_output_stream_1_full_n = ap_const_logic_0);
    end process;
    ...
    ap_sig_allocacmp_current_V_29_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, current_V, ap_block_pp0_stage0, ap_loop_init, current_V_21_fu_84, current_V_30_fu_338_p3)
    begin
    ...
    cancellation_unit_free_head_V_o_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, icmp_ln1081_fu_259_p2, icmp_ln1069_reg_425, cancellation_unit_free_head_V_i, current_V_29_reg_420, ap_block_pp0_stage1)
    begin
    ...
    cancellation_unit_total_size_V_o_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, icmp_ln1081_fu_259_p2, icmp_ln1069_reg_425, cancellation_unit_total_size_V_i, ap_block_pp0_stage1, add_ln887_5_fu_310_p2)
    begin
        if (((icmp_ln1069_reg_425 = ap_const_lv1_0) and (icmp_ln1081_fu_259_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    current_V_30_fu_338_p3 <= 
        reuse_reg1_load_reg_488 when (addr_cmp5_reg_493(0) = '1') else 
        cancellation_unit_buffer_next_V_q0;
    icmp_ln1069_fu_248_p2 <= "1" when (ap_sig_allocacmp_current_V_29 = ap_const_lv16_FFFF) else "0";
    icmp_ln1081_fu_259_p2 <= "1" when (signed(cancellation_unit_buffer_event_send_time_V_q0) > signed(tmp_to_time_V)) else "0";

    lpcore_cancellation_unit_output_stream_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, lpcore_cancellation_unit_output_stream_1_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    lpcore_cancellation_unit_output_stream_1_din <= (((((ap_const_lv1_1 & cancellation_unit_buffer_event_receiver_id_V_q0) & cancellation_unit_buffer_event_sender_id_V_q0) & cancellation_unit_buffer_event_data_V_q0) & cancellation_unit_buffer_event_recv_time_V_q0) & anti_message_send_time_V_reg_455);

    lpcore_cancellation_unit_output_stream_1_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            lpcore_cancellation_unit_output_stream_1_write <= ap_const_logic_1;
        else 
    ...
    zext_ln587_fu_254_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_current_V_29),64));
end behav;
