...
entity lpcore_top_lpcore_control_top is
port (
...
architecture behav of lpcore_top_lpcore_control_top is 
...
attribute shreg_extract : string;
    ...
    signal lpcore_commit_control_U0_lpcore_commit_time_stream_read : STD_LOGIC;
    ...
    component lpcore_top_lpcore_rollback_control IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component lpcore_top_lpcore_commit_control IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    lpcore_rollback_control_U0 : component lpcore_top_lpcore_rollback_control
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    lpcore_commit_control_U0 : component lpcore_top_lpcore_commit_control
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
