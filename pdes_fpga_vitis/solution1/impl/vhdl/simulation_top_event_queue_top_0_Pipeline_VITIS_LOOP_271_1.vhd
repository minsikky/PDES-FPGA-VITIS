...
entity simulation_top_event_queue_top_0_Pipeline_VITIS_LOOP_271_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of simulation_top_event_queue_top_0_Pipeline_VITIS_LOOP_271_1 is 
...
attribute shreg_extract : string;
    ...
    signal current_V_18_reg_209 : STD_LOGIC_VECTOR (15 downto 0);
    signal current_V_18_reg_209_pp0_iter1_reg : STD_LOGIC_VECTOR (15 downto 0);
    signal event_queue_lp_oldest_unissued_V_1_addr_reg_214 : STD_LOGIC_VECTOR (1 downto 0);
    signal event_queue_lp_oldest_unissued_V_1_addr_reg_214_pp0_iter1_reg : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal event_queue_buffer_event_recv_time_V_1_load_reg_238 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal icmp_ln1081_fu_155_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1081_reg_243 : STD_LOGIC_VECTOR (0 downto 0);
    signal event_queue_buffer_is_issued_V_1_addr_reg_247 : STD_LOGIC_VECTOR (6 downto 0);
    signal event_queue_buffer_is_issued_V_1_load_reg_252 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln587_14_fu_187_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    current_V_16_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                event_queue_lp_oldest_unissued_V_1_addr_reg_214 <= zext_ln145_cast_fu_130_p1(2 - 1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1069_reg_219 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln1081_fu_155_p2 = ap_const_lv1_1))) then
                event_queue_buffer_is_issued_V_1_addr_reg_247 <= zext_ln587_reg_223(7 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (event_queue_buffer_is_issued_V_1_load_reg_252 = ap_const_lv1_1) and (icmp_ln1081_reg_243 = ap_const_lv1_1))) then
    ...
    add_ln886_fu_169_p2 <= std_logic_vector(unsigned(event_queue_unissued_size_V_1_i) + unsigned(ap_const_lv16_1));
    ...
    ap_predicate_op36_store_state3_assign_proc : process(icmp_ln1069_reg_219, event_queue_buffer_is_issued_V_1_q0, icmp_ln1081_reg_243)
    begin
                ap_predicate_op36_store_state3 <= ((event_queue_buffer_is_issued_V_1_q0 = ap_const_lv1_1) and (icmp_ln1069_reg_219 = ap_const_lv1_0) and (icmp_ln1081_reg_243 = ap_const_lv1_1));
    end process;
    ...
    ap_sig_allocacmp_current_V_18_assign_proc : process(ap_CS_fsm_pp0_stage0, current_V, ap_block_pp0_stage0, current_V_16_fu_44, ap_loop_init)
    begin
    ...
    event_queue_buffer_event_recv_time_V_1_address0 <= zext_ln587_14_fu_187_p1(7 - 1 downto 0);
    event_queue_buffer_event_recv_time_V_1_address1 <= zext_ln587_fu_149_p1(7 - 1 downto 0);
    ...
    event_queue_buffer_event_recv_time_V_1_ce1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            event_queue_buffer_event_recv_time_V_1_ce1 <= ap_const_logic_1;
        else 
    ...
    event_queue_buffer_is_issued_V_1_address0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, zext_ln587_reg_223, event_queue_buffer_is_issued_V_1_addr_reg_247, ap_block_pp0_stage1, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                ...
                event_queue_buffer_is_issued_V_1_address0 <= zext_ln587_reg_223(7 - 1 downto 0);
            else 
    ...
    event_queue_buffer_is_issued_V_1_ce0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage1_11001, ap_block_pp0_stage2_11001)
    begin
    ...
    event_queue_buffer_is_issued_V_1_d0 <= ap_const_lv1_0;

    event_queue_buffer_is_issued_V_1_we0_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln1069_reg_219, ap_CS_fsm_pp0_stage2, event_queue_buffer_is_issued_V_1_q0, icmp_ln1081_reg_243, ap_block_pp0_stage2_11001)
    begin
        if (((event_queue_buffer_is_issued_V_1_q0 = ap_const_lv1_1) and (icmp_ln1069_reg_219 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln1081_reg_243 = ap_const_lv1_1))) then 
    ...
    event_queue_buffer_next_V_1_address0 <= zext_ln587_fu_149_p1(7 - 1 downto 0);

    event_queue_buffer_next_V_1_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    event_queue_lp_oldest_unissued_V_1_address0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, event_queue_lp_oldest_unissued_V_1_addr_reg_214, event_queue_lp_oldest_unissued_V_1_addr_reg_214_pp0_iter1_reg, ap_block_pp0_stage1, ap_block_pp0_stage2)
    begin
    ...
    event_queue_lp_oldest_unissued_V_1_ce0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage1_11001, ap_block_pp0_stage2_11001)
    begin
    ...
    event_queue_unissued_size_V_1_o_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln1069_reg_219, ap_CS_fsm_pp0_stage2, event_queue_buffer_is_issued_V_1_q0, event_queue_unissued_size_V_1_i, icmp_ln1081_reg_243, add_ln886_fu_169_p2, ap_block_pp0_stage2)
    begin
        if (((event_queue_buffer_is_issued_V_1_q0 = ap_const_lv1_1) and (icmp_ln1069_reg_219 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln1081_reg_243 = ap_const_lv1_1))) then 
    ...
    event_queue_unissued_size_V_1_o_ap_vld_assign_proc : process(ap_enable_reg_pp0_iter0, icmp_ln1069_reg_219, ap_CS_fsm_pp0_stage2, event_queue_buffer_is_issued_V_1_q0, icmp_ln1081_reg_243, ap_block_pp0_stage2_11001)
    begin
        if (((event_queue_buffer_is_issued_V_1_q0 = ap_const_lv1_1) and (icmp_ln1069_reg_219 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (icmp_ln1081_reg_243 = ap_const_lv1_1))) then 
            event_queue_unissued_size_V_1_o_ap_vld <= ap_const_logic_1;
        else 
            event_queue_unissued_size_V_1_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
    ...
    zext_ln587_fu_149_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_current_V_18),64));
end behav;
