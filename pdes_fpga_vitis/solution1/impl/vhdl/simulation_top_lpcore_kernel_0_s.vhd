...
entity simulation_top_lpcore_kernel_0_s is
port (
...
architecture behav of simulation_top_lpcore_kernel_0_s is 
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_lv2_0 : STD_LOGIC_VECTOR (1 downto 0) := "00";
    constant ap_const_logic_0 : STD_LOGIC := '0';

attribute shreg_extract : string;
    signal lpcore_control_top_0_U0_causality_violation_stream_read : STD_LOGIC;
    signal lpcore_control_top_0_U0_event_queue_rollback_info_stream_din : STD_LOGIC_VECTOR (47 downto 0);
    signal lpcore_control_top_0_U0_event_queue_rollback_info_stream_write : STD_LOGIC;
    signal lpcore_control_top_0_U0_state_buffer_rollback_info_stream_din : STD_LOGIC_VECTOR (47 downto 0);
    signal lpcore_control_top_0_U0_state_buffer_rollback_info_stream_write : STD_LOGIC;
    signal lpcore_control_top_0_U0_cancellation_unit_rollback_info_stream_din : STD_LOGIC_VECTOR (47 downto 0);
    signal lpcore_control_top_0_U0_cancellation_unit_rollback_info_stream_write : STD_LOGIC;
    signal lpcore_control_top_0_U0_lpcore_commit_time_stream_0_read : STD_LOGIC;
    signal lpcore_control_top_0_U0_event_queue_commit_time_stream15_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lpcore_control_top_0_U0_event_queue_commit_time_stream15_write : STD_LOGIC;
    signal lpcore_control_top_0_U0_state_buffer_commit_time_stream16_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lpcore_control_top_0_U0_state_buffer_commit_time_stream16_write : STD_LOGIC;
    signal lpcore_control_top_0_U0_cancellation_unit_commit_time_stream17_din : STD_LOGIC_VECTOR (31 downto 0);
    signal lpcore_control_top_0_U0_cancellation_unit_commit_time_stream17_write : STD_LOGIC;
    signal lpcore_control_top_0_U0_ap_ready : STD_LOGIC;
    ...
    signal event_queue_top_0_U0_lpcore_init_event_stream_0_read : STD_LOGIC;
    signal event_queue_top_0_U0_lpcore_event_queue_full_stream_0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal event_queue_top_0_U0_lpcore_event_queue_full_stream_0_write : STD_LOGIC;
    signal event_queue_top_0_U0_event_queue_rollback_info_stream_read : STD_LOGIC;
    signal event_queue_top_0_U0_lpcore_anti_message_stream_0_read : STD_LOGIC;
    signal event_queue_top_0_U0_lpcore_enqueue_event_stream_0_read : STD_LOGIC;
    ...
    signal event_processor_top_0_U0_lpcore_lvt_stream_0_din : STD_LOGIC_VECTOR (47 downto 0);
    signal event_processor_top_0_U0_lpcore_lvt_stream_0_write : STD_LOGIC;
    signal event_processor_top_0_U0_lpcore_output_event_stream_0_din : STD_LOGIC_VECTOR (128 downto 0);
    signal event_processor_top_0_U0_lpcore_output_event_stream_0_write : STD_LOGIC;
    ...
    signal cancellation_unit_top_0_U0_lpcore_cancellation_unit_output_stream_0_din : STD_LOGIC_VECTOR (128 downto 0);
    signal cancellation_unit_top_0_U0_lpcore_cancellation_unit_output_stream_0_write : STD_LOGIC;
    ...
    component simulation_top_lpcore_control_top_0_s IS
    port (
    ...
    component simulation_top_event_queue_top_0_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component simulation_top_state_buffer_top_0_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component simulation_top_event_processor_top_0_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component simulation_top_cancellation_unit_top_0_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component simulation_top_fifo_w48_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component simulation_top_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component simulation_top_fifo_w129_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component simulation_top_fifo_w80_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component simulation_top_fifo_w209_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    lpcore_control_top_0_U0 : component simulation_top_lpcore_control_top_0_s
    port map (
    ...
    event_queue_top_0_U0 : component simulation_top_event_queue_top_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        lpcore_event_queue_full_stream_0_num_data_valid => ap_const_lv2_0,
        lpcore_event_queue_full_stream_0_fifo_cap => ap_const_lv2_0,
        ...
        lpcore_anti_message_stream_0_num_data_valid => ap_const_lv2_0,
        lpcore_anti_message_stream_0_fifo_cap => ap_const_lv2_0,
        ...
        lpcore_enqueue_event_stream_0_num_data_valid => ap_const_lv2_0,
        lpcore_enqueue_event_stream_0_fifo_cap => ap_const_lv2_0,
    ...
    state_buffer_top_0_U0 : component simulation_top_state_buffer_top_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    event_processor_top_0_U0 : component simulation_top_event_processor_top_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        lpcore_lvt_stream_0_num_data_valid => ap_const_lv2_0,
        lpcore_lvt_stream_0_fifo_cap => ap_const_lv2_0,
        ...
        lpcore_output_event_stream_0_num_data_valid => ap_const_lv2_0,
        lpcore_output_event_stream_0_fifo_cap => ap_const_lv2_0,
    ...
    cancellation_unit_top_0_U0 : component simulation_top_cancellation_unit_top_0_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    causality_violation_stream_U : component simulation_top_fifo_w48_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    event_queue_rollback_info_stream_U : component simulation_top_fifo_w48_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    state_buffer_rollback_info_stream_U : component simulation_top_fifo_w48_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cancellation_unit_rollback_info_stream_U : component simulation_top_fifo_w48_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    event_queue_commit_time_stream_U : component simulation_top_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    state_buffer_commit_time_stream_U : component simulation_top_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cancellation_unit_commit_time_stream_U : component simulation_top_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    issued_event_stream_U : component simulation_top_fifo_w129_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    state_buffer_input_stream_U : component simulation_top_fifo_w80_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    event_processor_input_stream_U : component simulation_top_fifo_w209_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cancellation_unit_input_stream_U : component simulation_top_fifo_w129_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    cancellation_unit_top_0_U0_ap_continue <= ap_const_logic_1;
    cancellation_unit_top_0_U0_ap_start <= ap_const_logic_1;
    event_processor_top_0_U0_ap_continue <= ap_const_logic_1;
    event_processor_top_0_U0_ap_start <= ap_const_logic_1;
    event_queue_top_0_U0_ap_continue <= ap_const_logic_1;
    event_queue_top_0_U0_ap_start <= ap_const_logic_1;
    lpcore_anti_message_stream_0_read <= event_queue_top_0_U0_lpcore_anti_message_stream_0_read;
    lpcore_cancellation_unit_output_stream_0_din <= cancellation_unit_top_0_U0_lpcore_cancellation_unit_output_stream_0_din;
    lpcore_cancellation_unit_output_stream_0_write <= cancellation_unit_top_0_U0_lpcore_cancellation_unit_output_stream_0_write;
    lpcore_commit_time_stream_0_read <= lpcore_control_top_0_U0_lpcore_commit_time_stream_0_read;
    ...
    state_buffer_top_0_U0_ap_start <= ap_const_logic_1;
end behav;
