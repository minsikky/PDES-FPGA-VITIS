...
entity simulation_top_event_processor_top_1_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of simulation_top_event_processor_top_1_s is 
...
attribute shreg_extract : string;
    ...
    signal event_processor_prng_generators_state_V_q0 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component simulation_top_event_processor_top_1_s_event_processor_prng_generators_state_V_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
...
begin
    event_processor_prng_generators_state_V_U : component simulation_top_event_processor_top_1_s_event_processor_prng_generators_state_V_RAM_AUTO_1R1W
    generic map (
        DataWidth => 8,
        AddressRange => 16,
        AddressWidth => 4)
    ...
    lpcore_lvt_stream_1_write_assign_proc : process(tmp_reg_135, grp_process_event_fu_68_lpcore_lvt_stream_1_write, ap_CS_fsm_state3)
    begin
        if (((tmp_reg_135 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            lpcore_lvt_stream_1_write <= grp_process_event_fu_68_lpcore_lvt_stream_1_write;
        else 
    ...
    lpcore_output_event_stream_1_write_assign_proc : process(tmp_reg_135, grp_process_event_fu_68_lpcore_output_event_stream_1_write, ap_CS_fsm_state3)
    begin
        if (((tmp_reg_135 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
            lpcore_output_event_stream_1_write <= grp_process_event_fu_68_lpcore_output_event_stream_1_write;
        else 
