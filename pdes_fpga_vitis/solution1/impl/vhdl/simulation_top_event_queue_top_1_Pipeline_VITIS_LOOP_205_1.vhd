...
entity simulation_top_event_queue_top_1_Pipeline_VITIS_LOOP_205_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of simulation_top_event_queue_top_1_Pipeline_VITIS_LOOP_205_1 is 
...
attribute shreg_extract : string;
    ...
    signal i_V_1_reg_222 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_V_1_reg_222_pp0_iter1_reg : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal event_queue_lp_oldest_unissued_V_load_reg_236 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal earliest_time_V_1_fu_175_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal earliest_lp_V_fu_44 : STD_LOGIC_VECTOR (15 downto 0);
    signal earliest_lp_V_3_fu_183_p3 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal icmp_ln1073_1_fu_146_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal select_ln209_1_fu_167_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    add_ln886_fu_109_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_V_1) + unsigned(ap_const_lv3_1));
    ...
    ap_sig_allocacmp_i_V_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, i_V_fu_48)
    begin
    ...
    earliest_time_V_1_fu_175_p3 <= 
        earliest_time_V_fu_40 when (icmp_ln1069_fu_141_p2(0) = '1') else 
        select_ln209_fu_152_p3;
    event_queue_buffer_event_recv_time_V_address0 <= zext_ln587_fu_125_p1(7 - 1 downto 0);
    ...
    event_queue_lp_oldest_unissued_V_address0 <= i_V_cast_fu_115_p1(2 - 1 downto 0);

    event_queue_lp_oldest_unissued_V_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    i_V_cast_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_V_1),64));
    icmp_ln1069_fu_141_p2 <= "1" when (event_queue_lp_oldest_unissued_V_load_reg_236 = ap_const_lv16_FFFF) else "0";
    icmp_ln1073_1_fu_146_p2 <= "1" when (signed(earliest_time_V_fu_40) > signed(event_queue_buffer_event_recv_time_V_q0)) else "0";
    icmp_ln1073_fu_103_p2 <= "1" when (ap_sig_allocacmp_i_V_1 = ap_const_lv3_4) else "0";
    select_ln209_1_fu_167_p3 <= 
        zext_ln209_fu_163_p1 when (icmp_ln1073_1_fu_146_p2(0) = '1') else 
        earliest_lp_V_fu_44;
    select_ln209_fu_152_p3 <= 
        event_queue_buffer_event_recv_time_V_q0 when (icmp_ln1073_1_fu_146_p2(0) = '1') else 
        earliest_time_V_fu_40;
    trunc_ln209_fu_160_p1 <= i_V_1_reg_222_pp0_iter1_reg(2 - 1 downto 0);
    zext_ln209_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln209_fu_160_p1),16));
    zext_ln587_fu_125_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(event_queue_lp_oldest_unissued_V_q0),64));
end behav;
