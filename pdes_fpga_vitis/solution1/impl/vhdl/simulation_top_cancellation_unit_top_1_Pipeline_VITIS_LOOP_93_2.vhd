...
entity simulation_top_cancellation_unit_top_1_Pipeline_VITIS_LOOP_93_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of simulation_top_cancellation_unit_top_1_Pipeline_VITIS_LOOP_93_2 is 
...
attribute shreg_extract : string;
    ...
    signal current_V_28_reg_270 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal zext_ln587_23_fu_175_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal icmp_ln1065_fu_169_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal removed_V_fu_184_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal current_V_24_fu_44 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    current_V_24_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1069_fu_149_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                cancellation_unit_buffer_next_V_addr_reg_260 <= zext_ln587_fu_155_p1(6 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_sig_allocacmp_current_V_assign_proc : process(ap_CS_fsm_state1, current_V_27, current_V_24_fu_44, ap_loop_init)
    begin
    ...
    cancellation_unit_buffer_event_send_time_V_address0 <= zext_ln587_fu_155_p1(6 - 1 downto 0);
    ...
    begin
        if (((icmp_ln1069_reg_256 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln1085_reg_275 = ap_const_lv1_0))) then 
            ...
            cancellation_unit_buffer_next_V_address0 <= zext_ln587_23_fu_175_p1(6 - 1 downto 0);
        elsif (((icmp_ln1069_fu_149_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            cancellation_unit_buffer_next_V_address0 <= zext_ln587_fu_155_p1(6 - 1 downto 0);
        else 
    ...
    removed_V_11_out_o_ap_vld_assign_proc : process(ap_CS_fsm_state2, icmp_ln1085_fu_161_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln1085_fu_161_p2 = ap_const_lv1_0))) then 
            removed_V_11_out_o_ap_vld <= ap_const_logic_1;
        else 
            removed_V_11_out_o_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    removed_V_fu_184_p2 <= std_logic_vector(unsigned(removed_V_11_out_i) + unsigned(ap_const_lv16_1));
    zext_ln1073_cast_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln1073),64));
    zext_ln587_23_fu_175_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(prev_V_fu_48),64));
