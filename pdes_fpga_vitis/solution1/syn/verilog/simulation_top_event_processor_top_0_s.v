...
module simulation_top_event_processor_top_0_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg lpcore_lvt_stream_0_write;
reg lpcore_output_event_stream_0_write;
reg cancellation_unit_input_stream_write;

reg    ap_done_reg;
(* fsm_encoding = "none" *) reg   [2:0] ap_CS_fsm;
wire    ap_CS_fsm_state1;
wire   [7:0] event_processor_prng_generators_state_V_1_q0;
...
simulation_top_event_processor_top_0_s_event_processor_prng_generators_state_V_1_RAM_AUTO_1R1W #(
    ...
    .AddressRange( 16 ),
    .AddressWidth( 4 ))
event_processor_prng_generators_state_V_1_U(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (*) begin
    if (((tmp_reg_135 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        lpcore_lvt_stream_0_write = 1'b0;
    end
end
...
always @ (*) begin
    if (((tmp_reg_135 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
        ...
        lpcore_output_event_stream_0_write = 1'b0;
    end
end
...
assign lpcore_lvt_stream_0_din = grp_process_event_fu_68_lpcore_lvt_stream_1_din;

assign lpcore_output_event_stream_0_din = grp_process_event_fu_68_lpcore_output_event_stream_1_din;
...
endmodule //simulation_top_event_processor_top_0_s
