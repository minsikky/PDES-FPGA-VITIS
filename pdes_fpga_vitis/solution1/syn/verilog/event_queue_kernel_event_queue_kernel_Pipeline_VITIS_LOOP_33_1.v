...
module event_queue_kernel_event_queue_kernel_Pipeline_VITIS_LOOP_33_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [6:0] index_V_4_out;
output   index_V_4_out_ap_vld;
...
wire   [63:0] zext_ln587_2_fu_343_p1;
reg   [63:0] zext_ln587_2_reg_443;
wire   [0:0] icmp_ln1073_fu_357_p2;
reg   [0:0] icmp_ln1073_reg_457;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_state3_pp0_stage1_iter0;
wire    ap_block_pp0_stage1_11001;
wire   [63:0] zext_ln587_3_fu_362_p1;
reg   [63:0] zext_ln587_3_reg_461;
wire   [0:0] or_cond_fu_386_p2;
wire   [6:0] trunc_ln30_fu_400_p1;
reg   [6:0] trunc_ln30_reg_499;
...
reg   [15:0] index_V_1_fu_72;
wire   [15:0] index_V_cast_fu_258_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1065_fu_279_p2 == 1'd0))) begin
        ...
        zext_ln587_2_reg_443[15 : 0] <= zext_ln587_2_fu_343_p1[15 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1) & (icmp_ln1073_fu_357_p2 == 1'd1) & (icmp_ln1065_reg_434 == 1'd0))) begin
        zext_ln587_3_reg_461[15 : 0] <= zext_ln587_3_fu_362_p1[15 : 0];
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        g_event_queue_heap_data_V_address0 = zext_ln587_3_reg_461;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        g_event_queue_heap_data_V_address0 = zext_ln587_2_reg_443;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        g_event_queue_heap_is_anti_message_V_address0 = zext_ln587_3_reg_461;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        g_event_queue_heap_is_anti_message_V_address0 = zext_ln587_2_reg_443;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        g_event_queue_heap_receiver_id_V_address0 = zext_ln587_3_reg_461;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        g_event_queue_heap_receiver_id_V_address0 = zext_ln587_2_reg_443;
    end else begin
...
always @ (*) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
            g_event_queue_heap_recv_time_V_address0 = zext_ln587_3_fu_362_p1;
        end else if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
            g_event_queue_heap_recv_time_V_address0 = zext_ln587_2_fu_343_p1;
        end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        g_event_queue_heap_send_time_V_address0 = zext_ln587_3_reg_461;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        g_event_queue_heap_send_time_V_address0 = zext_ln587_2_reg_443;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        g_event_queue_heap_sender_id_V_address0 = zext_ln587_3_reg_461;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        g_event_queue_heap_sender_id_V_address0 = zext_ln587_2_reg_443;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state5) & (icmp_ln1065_reg_434 == 1'd0))) begin
        index_V_4_out_ap_vld = 1'b1;
    end else begin
        index_V_4_out_ap_vld = 1'b0;
    end
end
...
assign empty_fu_275_p1 = index_V_1_fu_72[6:0];

assign g_event_queue_heap_data_V_d0 = g_event_queue_heap_data_V_q0;

assign g_event_queue_heap_is_anti_message_V_d0 = g_event_queue_heap_is_anti_message_V_q0;

assign g_event_queue_heap_receiver_id_V_d0 = g_event_queue_heap_receiver_id_V_q0;

assign g_event_queue_heap_recv_time_V_d0 = g_event_queue_heap_recv_time_V_q0;

assign g_event_queue_heap_send_time_V_d0 = g_event_queue_heap_send_time_V_q0;

assign g_event_queue_heap_sender_id_V_d0 = g_event_queue_heap_sender_id_V_q0;

assign i_2_fu_351_p2 = (i_fu_68 + 32'd1);

assign icmp_ln1065_fu_279_p2 = ((index_V_1_fu_72 == 16'd0) ? 1'b1 : 1'b0);

assign icmp_ln1073_fu_357_p2 = (($signed(temp_recv_time_V) < $signed(g_event_queue_heap_recv_time_V_q0)) ? 1'b1 : 1'b0);

assign icmp_ln33_fu_380_p2 = (($signed(tmp_1_fu_370_p4) < $signed(25'd1)) ? 1'b1 : 1'b0);

assign index_V_4_out = trunc_ln30_reg_499;

assign index_V_cast_fu_258_p1 = index_V;

assign or_cond_fu_386_p2 = (icmp_ln33_fu_380_p2 & ap_phi_mux_cleanup_dest_slot_0_i_i_phi_fu_238_p4);
...
assign trunc_ln30_fu_400_p1 = index_V_1_fu_72[6:0];

assign zext_ln1559_fu_285_p1 = index_V_1_fu_72;

assign zext_ln587_2_fu_343_p1 = parent_V_fu_335_p3;

assign zext_ln587_3_fu_362_p1 = index_V_3_reg_424;

always @ (posedge ap_clk) begin
    zext_ln587_2_reg_443[63:16] <= 48'b000000000000000000000000000000000000000000000000;
    zext_ln587_3_reg_461[63:16] <= 48'b000000000000000000000000000000000000000000000000;
    ap_exit_tran_regpp0[1] <= 1'b0;
end

endmodule //event_queue_kernel_event_queue_kernel_Pipeline_VITIS_LOOP_33_1
