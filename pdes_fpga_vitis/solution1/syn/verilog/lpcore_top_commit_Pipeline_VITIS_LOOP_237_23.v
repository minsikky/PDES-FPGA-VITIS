...
module lpcore_top_commit_Pipeline_VITIS_LOOP_237_23 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln1065_14_fu_261_p2;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1065_14_fu_261_p2 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        event_queue_lp_youngest_issued_V_address0 = 64'd3;
    end else begin
...
assign addr_cmp5_fu_163_p2 = ((reuse_addr_reg2_fu_42 == 64'd3) ? 1'b1 : 1'b0);
...
assign event_queue_lp_heads_V_address0 = 64'd3;

assign event_queue_lp_heads_V_address1 = 64'd3;

assign event_queue_lp_heads_V_d0 = reuse_select_fu_244_p3;

assign event_queue_lp_tails_V_address0 = 64'd3;

assign event_queue_lp_tails_V_d0 = 16'd65535;

assign event_queue_lp_youngest_issued_V_addr_reg_333 = 64'd3;

assign event_queue_lp_youngest_issued_V_d0 = 16'd65535;

assign icmp_ln1065_14_fu_261_p2 = ((reuse_select_fu_244_p3 == 16'd65535) ? 1'b1 : 1'b0);
...
always @ (posedge ap_clk) begin
    ...
    reuse_addr_reg2_fu_42[1:0] <= 2'b11;
end

endmodule //lpcore_top_commit_Pipeline_VITIS_LOOP_237_23
