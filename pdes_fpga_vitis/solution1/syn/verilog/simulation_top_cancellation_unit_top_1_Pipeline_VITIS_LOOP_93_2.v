...
module simulation_top_cancellation_unit_top_1_Pipeline_VITIS_LOOP_93_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [15:0] current_V_27;
input  [1:0] zext_ln1073;
input  [31:0] tmp_18;
input  [15:0] removed_V_11_out_i;
output  [15:0] removed_V_11_out_o;
output   removed_V_11_out_o_ap_vld;
...
reg ap_idle;
reg[15:0] removed_V_11_out_o;
reg removed_V_11_out_o_ap_vld;
...
reg   [1:0] cancellation_unit_lp_heads_V_addr_reg_246;
reg   [1:0] cancellation_unit_lp_sizes_V_addr_reg_251;
reg   [0:0] icmp_ln1069_reg_256;
reg   [5:0] cancellation_unit_buffer_next_V_addr_reg_260;
reg   [15:0] current_V_28_reg_270;
...
wire   [63:0] zext_ln587_23_fu_175_p1;
wire   [0:0] icmp_ln1065_fu_169_p2;
wire   [15:0] removed_V_fu_184_p2;
reg   [15:0] current_V_24_fu_44;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1) & (ap_loop_init == 1'b1))) begin
        current_V_24_fu_44 <= current_V_27;
    end else if (((icmp_ln1069_reg_256 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        current_V_24_fu_44 <= current_V_28_reg_270;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln1069_fu_149_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        cancellation_unit_buffer_next_V_addr_reg_260 <= zext_ln587_fu_155_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        cancellation_unit_lp_heads_V_addr_reg_246 <= zext_ln1073_cast_fu_130_p1;
        cancellation_unit_lp_sizes_V_addr_reg_251 <= zext_ln1073_cast_fu_130_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        current_V_28_reg_270 <= cancellation_unit_buffer_next_V_q0;
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_current_V = current_V_27;
    end else begin
        ap_sig_allocacmp_current_V = current_V_24_fu_44;
    end
end
...
always @ (*) begin
    if (((icmp_ln1069_reg_256 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (icmp_ln1085_reg_275 == 1'd0))) begin
        ...
        cancellation_unit_buffer_next_V_address0 = zext_ln587_23_fu_175_p1;
    end else if (((icmp_ln1069_fu_149_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        cancellation_unit_buffer_next_V_address0 = zext_ln587_fu_155_p1;
    end else begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1085_fu_161_p2 == 1'd0))) begin
        removed_V_11_out_o = removed_V_fu_184_p2;
    end else begin
        removed_V_11_out_o = removed_V_11_out_i;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1085_fu_161_p2 == 1'd0))) begin
        removed_V_11_out_o_ap_vld = 1'b1;
    end else begin
        removed_V_11_out_o_ap_vld = 1'b0;
    end
end
...
assign cancellation_unit_buffer_event_send_time_V_address0 = zext_ln587_fu_155_p1;

assign cancellation_unit_lp_heads_V_address0 = cancellation_unit_lp_heads_V_addr_reg_246;

assign cancellation_unit_lp_heads_V_d0 = cancellation_unit_buffer_next_V_q0;

assign cancellation_unit_lp_sizes_V_address0 = cancellation_unit_lp_sizes_V_addr_reg_251;

assign cancellation_unit_lp_sizes_V_d0 = ($signed(cancellation_unit_lp_sizes_V_q0) + $signed(16'd65535));
...
assign icmp_ln1085_fu_161_p2 = (($signed(cancellation_unit_buffer_event_send_time_V_q0) > $signed(tmp_18)) ? 1'b1 : 1'b0);

assign removed_V_fu_184_p2 = (removed_V_11_out_i + 16'd1);

assign zext_ln1073_cast_fu_130_p1 = zext_ln1073;

assign zext_ln587_23_fu_175_p1 = prev_V_fu_48;

assign zext_ln587_fu_155_p1 = ap_sig_allocacmp_current_V;

endmodule //simulation_top_cancellation_unit_top_1_Pipeline_VITIS_LOOP_93_2
