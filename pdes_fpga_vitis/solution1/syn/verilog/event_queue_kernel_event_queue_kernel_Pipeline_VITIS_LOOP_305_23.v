...
module event_queue_kernel_event_queue_kernel_Pipeline_VITIS_LOOP_305_23 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        ap_ready,
        time_r,
        g_event_queue_lp_heads_V_3_i,
        g_event_queue_lp_heads_V_3_o,
        g_event_queue_lp_heads_V_3_o_ap_vld,
        ...
        g_event_queue_lp_tails_V_3,
        g_event_queue_lp_tails_V_3_ap_vld
);
...
output   ap_ready;
input  [31:0] time_r;
input  [15:0] g_event_queue_lp_heads_V_3_i;
output  [15:0] g_event_queue_lp_heads_V_3_o;
output   g_event_queue_lp_heads_V_3_o_ap_vld;
...
output  [15:0] g_event_queue_lp_tails_V_3;
output   g_event_queue_lp_tails_V_3_ap_vld;

reg ap_idle;
reg[15:0] g_event_queue_lp_heads_V_3_o;
reg g_event_queue_lp_heads_V_3_o_ap_vld;
...
reg g_event_queue_lp_tails_V_3_ap_vld;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        g_event_queue_lp_heads_V_3_o_ap_vld = 1'b1;
    end else begin
        g_event_queue_lp_heads_V_3_o_ap_vld = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1065_fu_166_p2 == 1'd1))) begin
        g_event_queue_lp_tails_V_3_ap_vld = 1'b1;
    end else begin
        g_event_queue_lp_tails_V_3_ap_vld = 1'b0;
    end
end
...
assign g_event_queue_lp_tails_V_3 = 16'd65535;
...
endmodule //event_queue_kernel_event_queue_kernel_Pipeline_VITIS_LOOP_305_23
