...
entity simulation_top_event_queue_top_1_Pipeline_VITIS_LOOP_271_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of simulation_top_event_queue_top_1_Pipeline_VITIS_LOOP_271_1 is 
...
attribute shreg_extract : string;
    ...
    signal current_V_12_reg_209 : STD_LOGIC_VECTOR (15 downto 0);
    signal current_V_12_reg_209_pp0_iter1_reg : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    current_V_11_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    ap_sig_allocacmp_current_V_12_assign_proc : process(ap_CS_fsm_pp0_stage0, current_V, ap_block_pp0_stage0, current_V_11_fu_44, ap_loop_init)
    begin
