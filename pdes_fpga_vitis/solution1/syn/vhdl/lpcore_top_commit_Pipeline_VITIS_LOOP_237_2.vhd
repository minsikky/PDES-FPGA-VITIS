...
entity lpcore_top_commit_Pipeline_VITIS_LOOP_237_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of lpcore_top_commit_Pipeline_VITIS_LOOP_237_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln1085_fu_186_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln1069_reg_310 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal commit_entry_V_fu_167_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal commit_entry_V_reg_304 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_state2_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal icmp_ln1069_fu_175_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln587_fu_181_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln587_reg_314 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal event_queue_lp_youngest_issued_V_addr_reg_331 : STD_LOGIC_VECTOR (1 downto 0);
    signal reuse_reg_load_reg_344 : STD_LOGIC_VECTOR (15 downto 0);
    signal addr_cmp_fu_197_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln887_fu_230_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal reuse_addr_reg2_fu_40 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal reuse_reg1_fu_44 : STD_LOGIC_VECTOR (15 downto 0);
    signal reuse_select_fu_242_p3 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    reuse_addr_reg2_fu_40_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                reuse_addr_reg2_fu_40 <= ap_const_lv64_FFFFFFFFFFFFFFFF;
            elsif (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
                reuse_addr_reg2_fu_40 <= ap_const_lv64_0;
            end if; 
        end if;
    end process;
    ...
    reuse_reg1_fu_44_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    reuse_reg1_fu_44 <= ap_const_lv16_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (icmp_ln1069_fu_175_p2 = ap_const_lv1_0))) then
                    zext_ln587_reg_314(15 downto 0) <= zext_ln587_fu_181_p1(15 downto 0);
            end if;
        end if;
    end process;
    zext_ln587_reg_314(63 downto 16) <= "000000000000000000000000000000000000000000000000";
    ...
    add_ln887_fu_230_p2 <= std_logic_vector(unsigned(event_queue_size_V_i) + unsigned(ap_const_lv16_FFFF));
    addr_cmp5_fu_161_p2 <= "1" when (reuse_addr_reg2_fu_40 = ap_const_lv64_0) else "0";
    addr_cmp_fu_197_p2 <= "1" when (reuse_addr_reg_fu_48 = zext_ln587_reg_314) else "0";
    ...
    ap_condition_exit_pp0_iter0_stage2_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_block_pp0_stage2_subdone, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and ((icmp_ln1069_reg_310 = ap_const_lv1_1) or (icmp_ln1085_fu_186_p2 = ap_const_lv1_1)))) then 
    ...
    commit_entry_V_fu_167_p3 <= 
        reuse_reg1_fu_44 when (addr_cmp5_fu_161_p2(0) = '1') else 
        event_queue_lp_heads_V_q1;
    event_queue_buffer_event_recv_time_V_address0 <= zext_ln587_fu_181_p1(7 - 1 downto 0);
    ...
    event_queue_buffer_next_V_address0 <= zext_ln587_reg_314(7 - 1 downto 0);

    event_queue_buffer_next_V_ce0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310, ap_block_pp0_stage2_11001)
    begin
        if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    event_queue_buffer_next_V_we0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310, ap_block_pp0_stage2_11001)
    begin
        if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    event_queue_free_head_V_o_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310, event_queue_free_head_V_i, commit_entry_V_reg_304, ap_block_pp0_stage2)
    begin
        if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    event_queue_free_head_V_o_ap_vld_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310, ap_block_pp0_stage2_11001)
    begin
        if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    event_queue_lp_heads_V_address0 <= ap_const_lv64_0(2 - 1 downto 0);
    event_queue_lp_heads_V_address1 <= ap_const_lv64_0(2 - 1 downto 0);
    ...
    event_queue_lp_heads_V_d0 <= reuse_select_fu_242_p3;
    ...
    event_queue_lp_tails_V_address0 <= ap_const_lv64_0(2 - 1 downto 0);
    ...
    event_queue_lp_youngest_issued_V_addr_reg_331 <= ap_const_lv64_0(2 - 1 downto 0);

    event_queue_lp_youngest_issued_V_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage2, event_queue_lp_youngest_issued_V_addr_reg_331, ap_block_pp0_stage0, ap_block_pp0_stage2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ...
            event_queue_lp_youngest_issued_V_address0 <= ap_const_lv64_0(2 - 1 downto 0);
        else 
    ...
    event_queue_lp_youngest_issued_V_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001, icmp_ln1065_fu_254_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (icmp_ln1065_fu_254_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    event_queue_size_V_o_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310, event_queue_size_V_i, ap_block_pp0_stage2, add_ln887_fu_230_p2)
    begin
        if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    event_queue_size_V_o_ap_vld_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, icmp_ln1085_fu_186_p2, icmp_ln1069_reg_310, ap_block_pp0_stage2_11001)
    begin
        if (((icmp_ln1069_reg_310 = ap_const_lv1_0) and (icmp_ln1085_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    reuse_select_fu_242_p3 <= 
        reuse_reg_load_reg_344 when (addr_cmp_reg_349(0) = '1') else 
        event_queue_buffer_next_V_q0;
    zext_ln587_fu_181_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(commit_entry_V_fu_167_p3),64));
end behav;
