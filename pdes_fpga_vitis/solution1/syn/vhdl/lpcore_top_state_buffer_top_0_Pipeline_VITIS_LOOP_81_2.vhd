...
entity lpcore_top_state_buffer_top_0_Pipeline_VITIS_LOOP_81_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of lpcore_top_state_buffer_top_0_Pipeline_VITIS_LOOP_81_2 is 
...
attribute shreg_extract : string;
    ...
    signal state_buffer_lp_heads_V_addr_reg_292 : STD_LOGIC_VECTOR (1 downto 0);
    signal state_buffer_lp_sizes_V_addr_reg_297 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                state_buffer_lp_heads_V_addr_reg_292 <= zext_ln1073_cast_fu_137_p1(2 - 1 downto 0);
                state_buffer_lp_sizes_V_addr_reg_297 <= zext_ln1073_cast_fu_137_p1(2 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
